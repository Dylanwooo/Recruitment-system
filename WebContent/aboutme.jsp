	...
	<div class="container-fluid" id="mainContainer">
		<div class="row">
			...
			<div class="col-md-9 col-sm-9" id="rightContent">
				...
				<hr/>
				<textarea style="width:600px;height:420px;">    中国科学院电子学研究所苏州研究院（简称电子所苏州研究院）由中科院电子所和苏州工业园区共建，设立于苏州工业园区纳米城内，为苏州地方事业法人单位。电子所苏州研究院总占地面积约150亩，位于苏州工业园区纳米城金鸡湖大道、星华街、独墅湖大道之间，环境优美，交通便利，配套完善。
