	...
	<div class="container-fluid" id="mainContainer">
		<div class="row">
			...
			<div class="col-md-9 col-sm-9" id="rightContent">
				<div style="position:relative;top:5px" class="col-md-offset-2 col-sm-offset-2 col-xs-offset-2">
					<span style="font:bold 2rem '微软雅黑';color:#333">中国科学院电子学研究所苏州研究院简介</span>
				</div>				
				<%-- <c:if test="${user.roleCode=='hr'}">
					<button class="btn btn-primary" type="button" style="border:none;background-color:#5baffa">
					<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button>
				</c:if> --%>
				<hr/>
				<textarea readonly style="width:600px;height:420px;font-family:'宋体'" >    中国科学院电子学研究所苏州研究院（简称电子所苏州研究院）由中科院电子所和苏州工业园区共建，设立于苏州工业园区纳米城内，为苏州地方事业法人单位。电子所苏州研究院总占地面积约150亩，位于苏州工业园区纳米城金鸡湖大道、星华街、独墅湖大道之间，环境优美，交通便利，配套完善。
