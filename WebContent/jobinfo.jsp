	   ...
	   <div class="row">
			<div class="col-md-3 col-sm-3 col-xs-3" id="buttonPanel">
		       ...
		       <div class="btn-group-vertical" role="group" aria-label="...">
		          ...
		          <button class="btn btn-default" type="button" data-toggle="modal" data-target="#recruitModal"><span class="glyphicon glyphicon-send"></span>招聘流程</button>
						...
						<c:forEach items="${jobinfolist }" var="jobinfo">
							<tr>
								...
								<c:if test="${user.roleCode=='hr'}">
								  ...
								  data-time='${jobinfo.endtime }'><span class="glyphicon glyphicon-edit" style="color:black"></span></button></td>			
								  <td class="oTd">
								  ...
								  <button class="btn btn-link" type="button" data-toggle="modal" onclick = "deleteJob('${jobinfo.id}',this)"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>
								   ...
								   <c:if test="${jobinfo.jobStatus==3}">								
								  <button class="btn btn-link" type="button" data-toggle="modal" onclick = "deletehrJob('${jobinfo.id}',this)"><span style="color:black" class="glyphicon glyphicon-trash" aria-hidden="true"></span>
								  </button>
								  </c:if>								  
								  </td>									  		
								</c:if>														
		...
		<div class="modal-content">
			...
			<div class="modal-body" style="position:relative; height:500px;">			   			   	     
		         <div style="position:absolute; float:left; display:inline; left:20px;">
		           <div style="float:left">
		              <input id="jobName" type="text" class="form-control" placeholder="岗位名称" style="width:200px;">
		           </div>	           
		           <div style="float:left; position:absolute; left:210px; top:8px;">
		           ...
		           <div style="float:left; position:absolute; left:300px; top:8px;">
		                 <select style="width:7s0px;" id="departmentSelect">
			                <option value="1">21室</option>
			                <option value="2">22室</option>			                
			              </select>
		              </div>
		           <div style="float:left;position:absolute; left:380px;">
		             <input type="text" class="form-control" value="${publishtime} " style="width:150px;" id="publishTime"
		              onclick="layui.laydate({elem:this, istime:true, format: 'YYYY-MM-DD'})">
		           </div>             
		         </div>
		         ...
		         <div style="position:relative;top:200px;">
		           <div style="position:absolute; left:10px;">
	                 <span class="glyphicon glyphicon-play" aria-hidden="true" style="color:black; font-size:20px;"></span>
	                  <span style="font-size:20px;"><strong>岗位要求</strong></span>
	               </div>
	               <div style="position:absolute; left:10px; top:30px;">
		          ...
		          <div style="position:relative;top:350px;">
			          <div style="position:absolute; left:10px;float:left;">
		                 <span class="glyphicon glyphicon-play" aria-hidden="true" style="color:black; font-size:20px;"></span> 
		                 <span style="font-size:20px;"><strong>学历要求</strong></span>
		              </div>
		              ...
		              <div style="position:absolute; right:230px;float:left;">
		                 <span class="glyphicon glyphicon-play" aria-hidden="true" style="color:black; font-size:20px;"></span> 
		                 <span style="font-size:20px;"><strong>截止时间</strong></span>
		              </div>
		         ...
		         <div style="position:relative;top:400px;">
		           <div style="position:absolute; left:10px;float:left;">
	                 <span class="glyphicon glyphicon-play" aria-hidden="true" style="color:black; font-size:20px;"></span>
	                 <span style="font-size:20px;"><strong>招聘人数</strong></span>
	               </div>
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
				    <button style="border-radius:0;background-color:#eca614;border:none;width:80px;font-family:'微软雅黑'" 
				     type="button" class="btn btn-primary" onclick="">确定</button>
